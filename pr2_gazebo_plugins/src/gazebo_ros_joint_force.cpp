...
#include <pr2_gazebo_plugins/gazebo_ros_joint_force.h>
...
GZ_REGISTER_DYNAMIC_CONTROLLER("gazebo_ros_joint_force", GazeboRosJointForce);

////////////////////////////////////////////////////////////////////////////////
// Constructor
GazeboRosJointForce::GazeboRosJointForce(Entity *parent )
  : Controller(parent)
{
...
////////////////////////////////////////////////////////////////////////////////
// Load the controller
void GazeboRosJointForce::LoadChild(XMLConfigNode *node)
{
    XMLConfigNode *jNode;
    Joint *joint;
...
void GazeboRosJointForce::InitChild()
{
...
void GazeboRosJointForce::UpdateChild()
{
  // this->myIface->Lock(1);
...
void GazeboRosJointForce::FiniChild()
{
}
