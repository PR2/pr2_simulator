...
#include <pr2_gazebo_plugins/gazebo_ros_factory.h>
...
void GazeboRosFactory::LoadChild(XMLConfigNode *node)
{
  ...
  this->spawnModelService = this->rosnode_->advertiseService(this->spawnModelServiceName,&GazeboRosFactory::spawnModel, this);

  this->deleteModelServiceNameP->Load(node);
  this->deleteModelServiceName = this->deleteModelServiceNameP->GetValue();
  this->deleteModelService = this->rosnode_->advertiseService(this->deleteModelServiceName,&GazeboRosFactory::deleteModel, this);
}
...
bool GazeboRosFactory::deleteModel(pr2_gazebo_plugins::DeleteModel::Request &req,
...
bool GazeboRosFactory::spawnModel(pr2_gazebo_plugins::SpawnModel::Request &req,
