...
#include <pr2_gazebo_plugins/gazebo_ros_step_world_state.h>
...
void GazeboRosStepWorldState::LoadChild(XMLConfigNode *node)
{
  ...
  this->sub_ = rosnode_->subscribe(this->topicName,100,&GazeboRosStepWorldState::WorldStateCallback,this);
...
void GazeboRosStepWorldState::WorldStateCallback(const pr2_gazebo_plugins::WorldStateConstPtr& worldStateMsg)
{
