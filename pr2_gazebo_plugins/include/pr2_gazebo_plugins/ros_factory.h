...
/** \defgroup RosFactory
  ...
  \verbatim
    <model:physical name="robot_model1">
      ...
      <controller:ros_factory name="ros_factory_controller" plugin="libros_factory.so">
        <alwaysOn>true</alwaysOn>
        <updateRate>1000.0</updateRate>
      </controller:ros_factory>
...
class RosFactory : public Controller
{
  /// \brief Constructor
  /// \param parent The parent entity, must be a Model or a Sensor
  public: RosFactory(Entity *parent);

  /// \brief Destructor
  public: virtual ~RosFactory();
