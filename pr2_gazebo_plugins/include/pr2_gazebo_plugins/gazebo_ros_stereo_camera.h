...
/// @{
/** \defgroup GazeboRosStereoCamera ROS stereo camera controller plugin
  ...
  <model:physical name="camera_model">
    <body:empty name="camera_body">
      <sensor:stereocamera name="stereo_camera_sensor">
        ...
        <controller:ros_stereocamera name="stereo_camera_controller" plugin="libgazebo_ros_stereo_camera.so">
...
class GazeboRosStereoCamera : public Controller
{
  /// \brief Constructor
  /// \param parent The parent entity, must be a Model
  public: GazeboRosStereoCamera(Entity *parent);

  /// \brief Destructor
  public: virtual ~GazeboRosStereoCamera();
