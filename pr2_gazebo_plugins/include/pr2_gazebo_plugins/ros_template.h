...
/** \defgroup RosTemplate
  ...
  \verbatim
    <model:physical name="robot_model1">
      ...
      <controller:ros_template name="ros_template_controller" plugin="libros_template.so">
        <alwaysOn>true</alwaysOn>
        <updateRate>1000.0</updateRate>
      </controller:ros_template>
...
class RosTemplate : public Controller
{
  /// \brief Constructor
  /// \param parent The parent entity, must be a Model or a Sensor
  public: RosTemplate(Entity *parent);

  /// \brief Destructor
  public: virtual ~RosTemplate();
