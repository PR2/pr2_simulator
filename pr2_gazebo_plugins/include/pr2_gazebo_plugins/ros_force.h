...
/// @{
/** \defgroup RosForce Plugin XML Reference and Example
  ...
  <model:physical name="box_model">
    ...
    <controller:ros_force name="box_force_controller" plugin="libros_force.so">
...
class RosForce : public Controller
{
  /// \brief Constructor
  /// \param parent The parent entity, must be a Model or a Sensor
  public: RosForce(Entity *parent);

  /// \brief Destructor
  public: virtual ~RosForce();
